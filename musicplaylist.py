...
class Music:
    ...
    async def summon(self, ctx):
        #summons / move bot to voice channel
    ...
    async def stop(self, ctx):
        # Clear queue, leaves voice channel
    ...
    async def skip(self, ctx):
        # Song requester skips it automatically
        # Others needs 3 votes to skip
        ...
        if voter == state.current.requester:
            await self.client.say('Skipped song...')
            state.skip()
